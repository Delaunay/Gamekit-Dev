...
UDecalComponent* initializeCursorToWorld(AChessyCharacter* self){
	...
	static ConstructorHelpers::FObjectFinder<UMaterial> DecalMaterialAsset(TEXT("Material'/Game/Tile/CursorDecal.CursorDecal'"));
...
AChessyCharacter::AChessyCharacter()
{
	...
	static ConstructorHelpers::FObjectFinder<UMaterial>
				CusorMaterialAsset(TEXT("Material'/Gamekit/Tiles/CursorMat.CursorMat'"));
