...
GAMEPROJECTFILE =/media/setepenre/Games/ChessyUE4/Chessy.uproject

TARGETS = \
	Chessy-Linux-Debug  \
	Chessy-Linux-DebugGame  \
	Chessy-Linux-Shipping  \
	Chessy-Linux-Test  \
	Chessy \
	ChessyEditor-Linux-Debug  \
	ChessyEditor-Linux-DebugGame  \
	ChessyEditor-Linux-Shipping  \
	ChessyEditor-Linux-Test  \
	ChessyEditor \
...
Chessy-Linux-Debug:
	 $(PROJECTBUILD) Chessy Linux Debug  -project="$(GAMEPROJECTFILE)" $(ARGS)

Chessy-Linux-DebugGame:
	 $(PROJECTBUILD) Chessy Linux DebugGame  -project="$(GAMEPROJECTFILE)" $(ARGS)

Chessy-Linux-Shipping:
	 $(PROJECTBUILD) Chessy Linux Shipping  -project="$(GAMEPROJECTFILE)" $(ARGS)

Chessy-Linux-Test:
	 $(PROJECTBUILD) Chessy Linux Test  -project="$(GAMEPROJECTFILE)" $(ARGS)

Chessy:
	 $(PROJECTBUILD) Chessy Linux Development  -project="$(GAMEPROJECTFILE)" $(ARGS)

ChessyEditor-Linux-Debug:
	 $(PROJECTBUILD) ChessyEditor Linux Debug  -project="$(GAMEPROJECTFILE)" $(ARGS)

ChessyEditor-Linux-DebugGame:
	 $(PROJECTBUILD) ChessyEditor Linux DebugGame  -project="$(GAMEPROJECTFILE)" $(ARGS)

ChessyEditor-Linux-Shipping:
	 $(PROJECTBUILD) ChessyEditor Linux Shipping  -project="$(GAMEPROJECTFILE)" $(ARGS)

ChessyEditor-Linux-Test:
	 $(PROJECTBUILD) ChessyEditor Linux Test  -project="$(GAMEPROJECTFILE)" $(ARGS)

ChessyEditor:
	 $(PROJECTBUILD) ChessyEditor Linux Development  -project="$(GAMEPROJECTFILE)" $(ARGS)
